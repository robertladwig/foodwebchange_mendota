...
phyto.all <- readRDS("robin-data/2022-06-23_biomass_aligned_by_strat_onset/interp.tables.all.rds")
phyto.swf <- readRDS("robin-data/2022-06-23_biomass_aligned_by_strat_onset/interp.tables.pre-post.rds")
label.x <- "Days since stratification onset"
plot.folder <- "plots/2022-06-23_biomas_aligned_by_stratification/onset_"

phyto.all <- readRDS("robin-data/2022-06-23_biomass_aligned_by_fall_mixing/interp.tables.all.rds")
phyto.swf <- readRDS("robin-data/2022-06-23_biomass_aligned_by_fall_mixing/interp.tables.pre-post.rds")
label.x <- "Days since fall mixing"
plot.folder <- "plots/2022-06-23_biomas_aligned_by_stratification/mixing_"
...
strat.def <- "yday"
strat.def <- "linear"
strat.def <- "constant.high"
strat.def <- "constant.low"
strat.def <- "spline"

plot.name <- paste0(plot.folder,"_",strat.def,"_strat-aligned_biomass.pdf")
